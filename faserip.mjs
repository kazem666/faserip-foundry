  ...
  try {
    ...
    try {
      game.settings.registerMenu("faserip", "rebuildCatalogs", {
        name: "Rebuild Power / Talent Compendia",
        label: "Seed Catalog Packs",
        hint: "Creates world Item packs FASERIP Powers and FASERIP Talents and copies missing catalog entries with descriptions.",
        icon: "fas fa-book",
    ...
    game.faserip = {
      ...
      ensureCatalogPacks, fillWorldDefinitions, buildCatalogItemData, describeCatalogItem,
